...
use PhpDb\Sql\Where;
use PhpDbTest\Adapter\Mysql\TestAsset\TrustingMysqlPlatform;
...
final class SelectTest extends TestCase
{
    ...
    public function testBadJoinName(): void
    {
        ...
        $this->expectException(InvalidArgumentException::class);
        $mr->invokeArgs($select, [new AdapterPlatform($mockDriver), $mockDriver, $parameterContainer]);
    }
    ...
    public function testOrder(): void
    {
        ...
        self::assertEquals(
            [[['RAND()']]],
            $method->invokeArgs($select, [new TrustingMysqlPlatform()])
        );
    ...
    public function testOrderCorrectlySplitsParameter(): void
    {
        ...
        self::assertEquals(
            ...
            $select->getSqlString(new TrustingMysqlPlatform())
        );
    }
    ...
    public function testPrepareStatement(
        ...
        $mockPlatform = $this->getMockBuilder(AdapterPlatform::class)
            ->onlyMethods([])
    ...
    public function testGetSqlString(Select $select, mixed $unused, mixed $unused2, string $expectedSqlString): void
    {
        ...
        self::assertEquals($expectedSqlString, $select->getSqlString($mockPlatform));
    }
